...
def create_second_stage_prompt(first_response: Dict[str, Any], combination: Dict[str, Any]) -> str:
    """
...
def get_combination_by_index(combinations: List[Dict[str, Any]], index: int) -> Optional[Dict[str, Any]]:
...
def save_prompts_to_file(prompts: List[Dict[str, Any]], filename: str = "generated_prompts.jsonl") -> None:
...
if __name__ == "__main__":
    ...
    config = yaml.safe_load(open("configs/dataset.yaml", 'r'))
